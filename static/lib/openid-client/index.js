...
var PopupUtils = class {
  ...
  static center({ ...features }) {
    ...
    if (features.width == null)
      features.width =
        (_a = [800, 720, 600, 480].find((width) => width <= window.outerWidth / 1.618)) != null ? _a : 360;
...
var SigninState = class _SigninState extends State {
  ...
  static async create(args) {
    const code_verifier =
      args.code_verifier === true ? CryptoUtils.generateCodeVerifier() : args.code_verifier || void 0;
...
var UserManagerSettingsStore = class extends OidcClientSettingsStore {
  constructor(args) {
    ...
    this.silentRequestTimeoutInSeconds =
      silentRequestTimeoutInSeconds || requestTimeoutInSeconds || DefaultSilentRequestTimeoutInSeconds;
...
var IFrameWindow = class _IFrameWindow extends AbstractChildWindow {
  ...
  async navigate(params) {
    ...
    const timer = setTimeout(
      () => void this._abort.raise(new ErrorTimeout('IFrame timed out without a response')),
...
var UserManager = class {
  ...
  async dpopProof(url, user, httpMethod, nonce) {
    var _a, _b;
    const dpopState = await ((_b = (_a = this.settings.dpop) == null ? void 0 : _a.store) == null
      ? void 0
