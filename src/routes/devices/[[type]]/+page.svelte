			...
			<div class="cosmo-modal__content">
				<div class="cosmo-input__group">
					...
					{#if selectedDeviceType === Type.Computer}
						...
						>
							<option selected={selectedDevice?.cpu?.manufacturer === 'GenuineIntel'} value="GenuineIntel">Intel</option>
							<option selected={selectedDevice?.cpu?.manufacturer === 'AuthenticAMD'} value="AuthenticAMD">AMD</option>
						</select>
