<script lang="ts">
	...
	function toggleFilter(type: Type) {
		if (deviceTypeFilter.has(type)) {
			deviceTypeFilter.delete(type);
		} else {
			deviceTypeFilter.add(type);
		}
							...
							<div class="jewels-new">
								...
								<div>
									...
									<div class="cosmo-message is--warning">
										...
										<p class="cosmo-message__message">
											Das Token ist nach dem Speichern nicht mehr verfügbar, bitte speicher es dir
											ab.
										</p>
									</div>
